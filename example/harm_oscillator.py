...
# plot solution
ODESolver.plotSolution(sol, phase_space=True, save=True, filename="harm_oscillator_euler.png", fileformat="png", fps=500)
...
# plot solution
ODESolver.plotSolution(sol, phase_space=True, save=True, filename="harm_oscillator_rk4.png", fileformat="gif", fps=500)